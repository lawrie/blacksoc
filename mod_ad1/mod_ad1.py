...
static inline uint8_t icosoc_@name@_xfer0() {
    *(volatile uint32_t*)(0x20000008 + @addr@ * 0x10000) = 0; 
    return *(volatile uint32_t*)(0x20000008 + @addr@ * 0x10000);
}

static inline uint8_t icosoc_@name@_xfer1() {
    *(volatile uint32_t*)(0x20000010 + @addr@ * 0x10000) = 0;
